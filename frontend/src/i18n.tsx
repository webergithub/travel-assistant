...
const ZH: Dict = {
  ...
  tab_plan: "🗺 行程",
  tab_packing: "🧳 打包清单",
  packing_title: "行前打包清单",
  packing_add_ph: "添加物品，回车确认…",
  packing_gen: "✨ AI 生成清单",
  packing_gen_demo: "▶ 演示清单",
  packing_generating: "生成中…",
  packing_added: "已添加 {n} 项",
  packing_empty: "还没有清单项。手动添加，或让 AI 按目的地和季节生成。",
  packing_progress: "{done}/{total} 已打包",
  cat_DOCS: "证件",
  cat_CLOTHES: "衣物",
  cat_ELECTRONICS: "电子",
  cat_TOILETRIES: "洗漱",
...
const EN: Dict = {
  ...
  budget_title: "Budget",
  budget_by_type: "By type",
  budget_by_day: "By day",
  currency_label: "Currency",
  tab_plan: "🗺 Itinerary",
  tab_packing: "🧳 Packing",
  packing_title: "Pre-trip packing list",
  packing_add_ph: "Add an item, press Enter…",
  packing_gen: "✨ AI generate",
  packing_gen_demo: "▶ Demo list",
  packing_generating: "Generating…",
  packing_added: "Added {n} items",
  packing_empty: "No items yet. Add manually, or let AI generate by destination and season.",
  packing_progress: "{done}/{total} packed",
  cat_DOCS: "Docs",
  cat_CLOTHES: "Clothes",
  ...
  cat_MEDS: "Meds",
  cat_OTHER: "Other",
  today_focus: "📍 Focus one day",
  all_days: "Show all",
  nav_here: "Navigate",
  nav_amap: "Amap",
  nav_gmap: "Google Maps",
  day_subtotal: "Subtotal",
};
